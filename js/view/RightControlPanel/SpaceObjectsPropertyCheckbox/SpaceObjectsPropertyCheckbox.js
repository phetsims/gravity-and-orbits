...
define( function( require ) {
  ...
  var pathIcon = require( 'image!GRAVITY_AND_ORBITS/../images/icon_path.png' );
  var measuringTapeIcon = require( 'image!GRAVITY_AND_ORBITS/../images/measuringTape.svg' );
  var massIcon = require( 'image!GRAVITY_AND_ORBITS/../images/icon_mass.svg' );
  ...
  function SpaceObjectsPropertyCheckbox( model, coords ) {
    ...
    var options = [
      ...
      },
      {
        ...
        node: new Node( {children: [new Image( pathIcon )], x: 70, y: -23} )
      },
      {
      ...
      },
      {
        ...
        node: new Node( {children: [new Image( measuringTapeIcon )], x: 140, y: -23, scale: 0.5} )
      },
      {
        property: model.massProperty,
        text: Strings['GAO.mass'],
        node: new Node( {children: [new Image( massIcon )], x: 70, y: -23} )
      }
    ], dy = 25;
