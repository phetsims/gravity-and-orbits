...
(5) Open in the browser: `http://localhost/gravity-and-orbits/gravity-and-orbits_en.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
...
(3) Open in the browser: `http://localhost/gravity-and-orbits/build/adapted-from-phet/gravity-and-orbits_en_adapted-from-phet.html` (You will probably need to modify this URL based on your HTTP port and relative path.)
